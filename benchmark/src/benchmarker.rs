...
impl Benchmarker {
    ...
    pub fn benchmark_reauth(&mut self) {
        ...
        const REPS: usize = 10;
        const NUMS_MISSED: &[usize] = &[10, 50, 100, 200];
        const MAX_REAUTH_ITER: usize = 200;
		...
		writeln!(writer, "key_selection\tkey_lifetime\tPC\tnum_received\tnum_missed\tnum_to_reauth").unwrap();
